...
print("=== Test etape 10: Sortir une voiture du parc ===")
...
print("Avant retrait - Places libres: " + str(parc.calculerNbrPlacesLibres()))
parc.sortirVoiture("ABC123")
print("Apres retrait - Places libres: " + str(parc.calculerNbrPlacesLibres()))
